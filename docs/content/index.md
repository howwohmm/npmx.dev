...
:::u-page-feature{icon="i-lucide:keyboard" to="/guide/keyboard-shortcuts" title="Navigate with keyboard" description="Open the command palette with ⌘K or Ctrl+K, press / to search, and use arrow keys to move fast."}
:::
